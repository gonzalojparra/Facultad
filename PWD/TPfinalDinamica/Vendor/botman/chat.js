// Chat frame. When you open the web widget, it will load an iframe containing the chat area.  In order to load this frame, create a URL/route that is accessible from your applicacion and contains the chat frame sourcecode.

// You will now see a message icon in the bottom right corner. When you click it, will open the chat widget.
